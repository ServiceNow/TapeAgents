...
content = content[1:]
    ...
    def get_logprobs_complete(self, prompt: str, output: str) -> ChoiceLogprobs:
        """
    ...
    def get_logprobs_chat_complete(self, prompt: Prompt, output: LLMOutput) -> ChoiceLogprobs:
        """
    ...
    def get_logprobs(self, prompt: str | Prompt, output: str | LLMOutput) -> ChoiceLogprobs:
        """
