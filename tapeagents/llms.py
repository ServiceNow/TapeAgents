...
class TrainableLLM(CachedLLM):
    ...
    def get_log_probs_complete(self, prompt: str, output: str) -> ChoiceLogprobs:
        """
        ...
        return ChoiceLogprobs(content=completion_log_probs)

    def get_log_probs_chat_complete(self, prompt: Prompt, output: LLMOutput) -> ChoiceLogprobs:
        """
    ...
    def get_log_probs(self, prompt: str | Prompt, output: str | LLMOutput) -> ChoiceLogprobs:
        """
